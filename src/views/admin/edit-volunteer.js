        ...
        <div class="attachments-section">
          ...
          <div class="attachments-list">
            ${email.attachments.map(att => `
              <a href="/admin/api/emails/attachments/${att.id}/download" 
                 target="_blank"
    ...
    const modalContent = `
        ...
        <div class="email-content-section">
          ...
          <div class="email-content-body">
            ${email.html_content ? 
              `<iframe srcdoc="${email.html_content.replace(/"/g, '&quot;')}"></iframe>` :
              `<div style="padding: 1rem; font-style: italic; color: #666;">${escapeHtml(email.content || 'No content available')}</div>`
            }
          </div>
        </div>
    `;
